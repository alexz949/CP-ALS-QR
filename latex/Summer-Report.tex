...
The algorithm first performs QR on each factor matrix in $\mat{Z}_k$, which yields
\begin{align*}
...
If we have a Kruskal tensor input, the right hand side is computed more cheaply by applying cross products for $\mat{Q}_k^\top\mat{B}_k$
\begin{equation}
