...
\begin{table}[!ht] 
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
    ...
    \hline
    3 &1000&$10^4$ &  1.27e-08& 1.41e-12& 1.52e-12 \\
    4 &100 &$10^6$& 7.01e-04& 1.59e-10& 1.55e-10\\
    5&50 &$10^8$& 0.26& 2.11e-08 & 1.93e-08\\
    6 & 25&$10^{10}$& 0.19& 2.35e-06 & 2.22e-06\\
    7 & 15 & $10^{12}$ & 0.47 &0.003 & 2,99e-04\\
    8 & 10& $10^{14}$ & 0.55 & 0.03 & 0.02\\
    \hline
  \end{tabular}
...
Figure indicating speed differencs is showed in \cref{fig:LS_problem_log}.
\begin{figure}[!ht]
...
In the next breakdown figure, we will later see where the majority time goes.
Take a closer look at NE and QR Imp techniques, \cref{fig:LS_problem_breakdown} further shows time distributions on NE and QR Imp on different computation components.
