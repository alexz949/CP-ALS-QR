...
For ALS approach in CP decomposition, we try to solve least square problem with multiple right hand sides.
...
The QR-based method computes QR decomposition for $\mat{A} = \mat{Q}\mat{R}$, and solves the equation $\mat{R}\mat{X} = \mat{Q}^\top\mat{B}$.
...
The second QR decomposition is exponential to number of modes because of the explicit formation of Khatri-Rao product. 
This also increases the cost for doing $\mat{Q}^\top\mat{B}$.
...
This strict the time for doing QR to only $r^4$.
