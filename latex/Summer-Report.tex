...
This cost is often not the bottleneck when computing CP decompositions of dense tensors.
However, in the context of CP Rounding, or computing a lower-rank CP decomposition of an input already in CP format, the exponential cost is infeasible for large problems.
...
\GB{First paragraph was great, tells the story at the right level of detail.  I made a pass and adjusted things a bit, but pretty minor.  In general, use present tense}
