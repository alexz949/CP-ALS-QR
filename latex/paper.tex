...
\begin{figure}[ht!]
 ...
 \includegraphics*[width=0.98\textwidth]{single_precission_10000_3.pdf}
    \caption[Figure]{Comparison of accuracy and running time of NE and QR Imp based CP-ALS algorithms in single and double precision. \label{fig:single_precission}}
  \end{center}  
\end{figure}
