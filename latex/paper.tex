...
\begin{table}[!ht] 
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
    ...
    Compute Gram [Lines \ref{l:NE-Hada} and \ref{l:NE-Gram}]   & $d \bar{n} r^2 + d^2r^2 $ & QR on factor matrices [Line \ref{l:cp-als-q-exp:updateQR}] & $4d \bar n r^2$ & QR on factor matrices [Line \ref{l:pairwise-factorQR}]                 & $4d \bar n r^2$\\
     ...
     NE Solve [Line \ref{l:NE-solve}]                                              & $2d\bar{n}r^2 $                & Back Solve [Line \ref{l:cp-als-q-exp:solve}]                          & $d\bar{n} r^2$   & Back Solve [Line \ref{l:pairwise-solve}]& $d\bar{n} r^2$\\
    \hline
...
\begin{table}[!ht] 
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
    ...
    Compute Gram [Lines \ref{l:round-ne-gram} and \ref{l:NE-K-Gram}] & $d\bar n r^2+d^2r^2$ &QR on factor matrices [Line \ref{l:cp-round-qr-updateqr}]                        &  $4d \bar n r^2$  & QR on factor matrices [Line \ref{l:Pair-K-update}]                         & $4d \bar n r^2$\\
                                                                                                               ...
                                                                                                               &                                    &Apply $\mat{Q}_0$ [Line \ref{l:EXP-mttkrp}]                                            &  $2dr^ds$           & Apply pairwise $\M[\hat]{Q}$  [Line \ref{l:pair-QR-Rapply}]           & $2dsr^3$\\
   NE Solve [Line \ref{l:NE-K-solve}]                                                      & $2d\bar{n}r^2 $           & Back Solve [Line \ref{l:cp-round-qr-solve}]                                              &  $d\bar{n} r^2$   & Back Solve [Line \ref{l:Pair-K-solve}]                                            & $d\bar{n} r^2$\\

    \hline
     Leading term & $4d\bar n rs$ & Leading term & $2dr^ds+4d\bar{n} rs$ & Leading term & $4d\bar n rs$ \\
    \hline
  \end{tabular}
  }
