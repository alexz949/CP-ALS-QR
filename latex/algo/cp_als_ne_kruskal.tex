...
\begin{algorithmic}[1]
    ...
    \For{$k = 1, \dots, d$}
      ...
      \State $\mat{D}_k = \mat{B}_k(\mat{C}_d \hada \cdots  \hada\mat{C}_{k+1} \hada \mat{C}_{k-1} \hada \cdots\hada \mat{C}_1)$ \Comment{compute $\mat{X}_{(k)}\mat{Z}_k}$ \label{l:round-ne-rhs}
