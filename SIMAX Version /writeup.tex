...
\Cref{sec:algs} details the various methods for exploiting the structure of these coefficient matrices, including via the normal equations (see \cref{sec:alg:ne} for more details).
...
These costs, incurred in \cref{l:round-ne-rhs,l:NE-K-cross}, are $2n_krs+(d-2)rs$ and $2n_krs$ in mode $k$, respectively.
