...
\begin{algorithmic}[1]
    \Function{$\{\M{A}_{k}\}=$ CP-Round-ALS-QR-Exp}{$\{\M{B}_{k}\},r$}
      ...
      \While{not converged}
        \For{$k = 1, \dots, d$}
          \State $[\mat{Q}_0,\mat{R}_0] = \Call{QR}{\mat{R}_d \odot \cdots \odot \mat{R}_{k+1} \odot \mat{R}_{k-1} \odot \cdots \odot \mat{R}_1}$ \Comment{explicit QR} \label{l:cp-round-als-exp-qr}
