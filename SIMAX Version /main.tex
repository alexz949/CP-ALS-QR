...
We summarize our conclusions in \cref{sec:conclusion} and discuss future directions based on the proposed method. The source code for the reproducibility of our experiment results is available at: \url{https://github.com/alexz949/CP-Rounding.git}.
...
We use a random guess for initialization, and all algorithms start with the same initial factor matrices.
