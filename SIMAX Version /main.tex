...
\blfootnote{The source code for the experimental results is available at: \url{https://github.com/alexz949/CP-Rounding.git}}
...
Our experiments with a single least squares problem show that if the problem is very ill conditioned (condition number of \texttt{4e13}), our algorithm achieves an error that is 9 orders of magnitude smaller than the normal equations approach.
