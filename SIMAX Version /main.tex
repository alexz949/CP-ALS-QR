...
We note that computing the objective function value at each iteration can be done cheaply with both NE and QR methods \cite[Section 3.3.1]{MVLB23}.}
...
These costs, incurred in lines \ref{l:round-ne-rhs} and \ref{l:NE-K-cross}, are $2n_krs+(d-2)rs$ and $2n_krs$ in mode $k$, respectively.
