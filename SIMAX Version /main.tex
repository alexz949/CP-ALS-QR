...
Considering a Khatri-Rao product of three matrices each with $r$ columns, we exploit the following identities, where each computed QR decomposition is denoted using underbraces:
...
\begin{equation*}
{4d\bar{n}rs} + O(d\bar{n}r^2 + d^2rs + d^2r^2 + r^3).
\end{equation*}
...
\begin{figure}[ht!]
  \begin{center}
    ...
    \caption[Figure]{Comparison of run time for single least squares sine-of-sums problem when varying $d$ for NE, QR Imp, and QR Exp ($n=2000$) \label{fig:LS_problem_line}}
  \end{center}
\end{figure}
...
\begin{figure}[ht!]
  \begin{center}
    ...
    \caption[Figure]{Breakdown of run time for single least squares sine-of-sums problem when varying $d$ for NE and QR Imp ($n=2000$) \label{fig:LS_problem_breakdown}}
  \end{center}
\end{figure}
...
\begin{figure}[ht!]
  \begin{center}
    ...
    \caption[Figure]{Comparison of per-iteration run time for CP-ALS on sine-of-sums CP Rounding problem when varying $d$ and $n$ for NE, QR Imp, and QR Exp \label{fig:runtime}}
  \end{center}
\end{figure}
...
\begin{figure}[ht!]
  \begin{center}  
    ...
    \caption[Figure]{Comparison of CP-ALS convergence behavior of NE and QR Imp on sine-of-sums tensor for varying $d$ and random initializations ($n=10$) \label{fig:error}}
  \end{center}  
\end{figure}
...
\begin{figure}[ht!]
 ...
 \includegraphics*[width=0.98\textwidth]{single_precission_10000_3_updated.pdf}
    \caption[Figure]{Comparison of accuracy and running time of NE and QR Imp based CP-ALS algorithms in single and double precision. \label{fig:single_precission} }%\AZ{maybe add markers to differentiate 3 coinciding error curves} \GB{maybe run two more trials, and if they are consistent, let's just show one convergence plot and say that it is representative} }
  \end{center}  
\end{figure}
