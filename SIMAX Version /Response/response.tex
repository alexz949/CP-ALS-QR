...
\response{Thank you for the suggestion.  For this experiment, $\theta$ (the angle between $Ax$ and $b$) is zero in exact arithmetic, which means $\tan \theta \approx 0$ and the forward error of QR is governed by $\kappa \cdot \epsilon_{mach}$.  We have added a sentence to the discussion in Section 4.2 to make this point and better explain the numerical observations.  We also computed $\theta$ and $\eta$ for all the right hand sides of the experiment and observed ... \GB{need to fill in here}}
