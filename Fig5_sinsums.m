...
T = sinsum_full(d,n); % rank d representation
X = sinsums(d,n);
...
[M_svd,U_svd,out_svd1] = cp_als_qr_new(T,r,'init',U_als,'maxiters',maxiter,'tol',tol,'printitn',10,'errmethod','lowmem');
...
% CP-ALS-QR-SVD
[M_svd,U_svd,out_svd] = cp_als_qr_new(T,r,'init',U_als,'maxiters',maxiter,'tol',tol,'printitn',10,'errmethod','lowmem');
